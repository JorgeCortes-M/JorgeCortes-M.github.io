...
```
Esto nos genera un dataframe de una única columna con los continentes. ![Filtrado por continentes](/JorgeCortes-M.github.io/images/select_continent_blog_1.JPG)
...
```
Ahora tenemos un data frame con tres columnas. ![Data Frame con dos columnas](/JorgeCortes-M.github.io/images/select_mult_col_blog_1.JPG)
...
Así obtenemos el siguiente dataframe ![Data frame ends_with](/JorgeCortes-M.github.io/images/select_ends_with.JPG)
